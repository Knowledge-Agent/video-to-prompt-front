...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      ...
      description: 'custom activity modules visibility',
      tab: 'ai',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'activity_ai_tasks_enabled',
      title: 'Activity AI Tasks Enabled',
      type: 'switch',
      value: 'true',
      group: 'activity',
      tab: 'ai',
    ...
    {
      name: 'activity_ai_chats_enabled',
      title: 'Activity AI Chats Enabled',
      type: 'switch',
      value: 'true',
      group: 'activity',
      tab: 'ai',
...
export const publicSettingNames = [
  ...
  'google_client_id',
  'github_auth_enabled',
  'activity_ai_tasks_enabled',
  'activity_ai_chats_enabled',
