...
image: "/imgs/blog/tavily/video-prompt-shot-language-framework-1.png"
---
...
![Many prompts fail because they describe "what" but not "how". Shot language solv](/imgs/blog/tavily/video-prompt-shot-language-framework-2.png)

A useful prompt should not only say the subject and environment. It should also encode:

![A useful prompt should not only say the subject and environment. It should also ](/imgs/blog/tavily/video-prompt-shot-language-framework-3.png)
...
![Use this sentence pattern:](/imgs/blog/tavily/video-prompt-shot-language-framework-4.png)

> Subject + Setting + Camera Action + Lens/Depth + Lighting + Mood + Temporal Cue

Example:

![Example:](/imgs/blog/tavily/video-prompt-shot-language-framework-5.png)
...
![Shot language is the bridge between reference footage and controllable generatio](/imgs/blog/tavily/video-prompt-shot-language-framework-6.png)